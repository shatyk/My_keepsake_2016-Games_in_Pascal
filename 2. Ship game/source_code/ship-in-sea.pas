...
if gaov=7 then 
  ...
  begin
    ...
    case sl of
      1 : begin
            textout(5, 95, 'Вы победили (сложность: легко). Пройдите игру на более высокой сложности, чтобы получить нихуя.');
            textout(5, 120, 'Можете нажать на ентер, и сыграть еще разок.');
          end;
      2 : begin
            textout(5, 95, 'Вы победили (сложность: нормально). Скинте скрин разрабу игры, и он выдаст вам нихуя при встрече.');
            textout(5, 120, 'Можете нажать на ентер, и сыграть еще разок.');
          end;
      3 : begin
            textout(5, 95, 'Вы победили (сложность: сложно). Скинте скрин разрабу игры, и он выдаст вам ДВА нихуя при встрече.');
            textout(5, 120, 'Можете нажать на ентер, и сыграть еще разок.');
          end;
    end;
  end;
